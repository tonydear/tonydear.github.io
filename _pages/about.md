...
I am a lecturer in the [Computer Science Department](http://www.cs.columbia.edu) of the [School of Engineering and Applied Science](https://engineering.columbia.edu/) (SEAS) at [Columbia University](https://www.columbia.edu/). This semester (Fall 2024), I am teaching Discrete Mathematics (COMS 3203) and Data-Driven Decision Modeling (ORCS 4200). If you are my [academic advisee](https://www.cs.columbia.edu/education/undergraduate/advisors/), please feel free to reach out by email for an appointment.
